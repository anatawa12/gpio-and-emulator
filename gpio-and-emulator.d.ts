...
declare interface Selected extends EventEmitter {
...
declare interface RpiGpioPromise {
...
declare interface DoneOrErrorCallback {
    (): void

    (error: Error): void
}

declare interface ValueOrErrorCallback<T> {
